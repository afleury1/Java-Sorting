...
/**
 * Class contains the method runSort which is called by the appDriver main
 * method. This starts various sorting methods depending on the user input on
...
public class RunSort {
	 ...
	 * polyfor1 text file) and generates a java array of Shape type populated by
	 * those records. Finally, based off the user inputs from the main class the
	 * method calls the user specified compare type and sort types and compares them
	 * while displaying a partial sorted list of shapes and the time it took for the
	 * application to sort and compare them.
	 * 
	 * @param filename    Sting input from user passing from argument from command
	 *                    line
	 * @param compareType String input from user passing from argument from command
	 *                    line
	 * @param sortType    String input from user passing from argument from command
	 *                    line
	 * @throws InvalidArgFormatException If the input type is not in the predefined
	 *                                   pool, throws InvalidArgFormatException.
	 * @throws FileNotFoundException     if the file is not found, throw
	 *                                   FileNotFoundException.
	 */
	public void runSort(String filename, String compareType, String sortType)
			throws InvalidArgFormatException, FileNotFoundException {
