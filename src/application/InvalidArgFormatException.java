...
public class InvalidArgFormatException extends Exception {
	...
	/**
	 * Exception Handler whenever the input argument is missing one of the required
	 * fields (filepath, compare type or sort type)
	 * 
	...
	public InvalidArgFormatException(int fileArgCount, int compareArgCount, int sortArgCount) {
		...
		System.out.println(
				"Expected: 3 argumensts in any order, case insensitive, 1 for filepath, 1 for compare method, 1 for sort method.");
	}

	/**
	 * Exception Handler whenever the input argument is not in the pool of accepted
	 * type
	 * 
