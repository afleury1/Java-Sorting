...
public class AppDriver {
	...
	/**
	 * Entry point to Java application. It parse the arguments in command line to
	 * check if they are valid. If valid, start the sorting process by initializing
	 * RunSort object.
	 * 
	 * @param args user inputs in the command line
	 * @throws InvalidArgFormatException If the arguments in command line are
	 *                                   invalid
	 */
	public static void main(String[] args) throws Exception {
		try {
			...
			System.out.println(
					"For sort type (only 6 possibilities):b is bubble, s is selection, i is insertion, m is merge, q is quick, and z is custom sort (shell sort).");
		}
	}

	/**
	 * Entry point to Java application. It read and count the input arguments.
	 * 
	 * @param args the input read from command line
	 * @throws Exception throwing exception when the number of arg is not 3 OR if it
	 *                   is missing required arguments type.
	 */
