...
public class Shape implements Comparable<Shape> {
	...
	/**
	 * This method is called by Shape depending on the name and then assigns a
	 * radius value to the shape object.
	 * 
	 * @param name      is the type of shape
	 * @param secondNum is the numerical value that will be assigned as a radius
	 * @return value Depending on the shape the return value will be the set radius
	 *         or invalid
	 */
	...
	/**
	 * This method is called by Shape depending on the name and then assigns a side
	 * value to the shape object.
	 * 
	 * @param name      is the type of shape
	 * @param secondNum is the numerical value that will be assigned as a side
	 * @return depending on the shape, the return value will be the set side or
	 *         invalid.
	 */
	...
	/**
	 * This method is called by Shape depending on the name and then calculates a
	 * base area value that is then assigned to the shape object.
	 * 
	 * @param name is the type of shape
	...
	/**
	 * This method is called by Shape depending on the name and then calculates a
	 * volume value that is then assigned to the shape object.
	 * 
	 * @param name is the type of shape
